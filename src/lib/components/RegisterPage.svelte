<section class="bg-gray-50 dark:bg-gray-900">
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <a href="#" class="flex items-center mb-6 text-6xl font-semibold text-gray-900 dark:text-white">
            <img class="w-16 h-16 mr-4" src="./src/lib/assets/logo.png" alt="logo">
            Lorem
        </a>
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form method="POST" class="space-y-4 md:space-y-6" action="">
                    ...
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                        Já tem uma conta? <a href="/login" class="font-medium text-violet-600 hover:underline dark:text-primary-500">Logar</a>
                    </p>
                </form>
            </div>
        </div>
