        ...
        <div class="hidden lg:mt-0 lg:col-span-5 lg:flex justify-end">
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 hover:shadow-lg">
                ...
                <div class="p-5">
                    ...
                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">O Jardim da Aprendizagem é o lugar onde a educação e o cuidado se unem para criar o ambiente perfeito para o crescimento de seu filho. Somos uma escola dedicada a proporcionar um início sólido na jornada de aprendizado de cada criança</p>
